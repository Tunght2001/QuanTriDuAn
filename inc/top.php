        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><img height="20px" width="20px" src="admin/slider/uploads/15877259134838_pastedimage0.png" alt=""><?php echo 'Xin Chào!  ' .$_SESSION['user_login'] ?></li>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <form action="search.php" method="get" style="margin-top: 10px" class="my-2 form-inline my-lg-0">
                                <input class="form-control mr-sm-2" type="search" name="search_key" placeholder="Nhap tu khoa.." aria-label="Search">
                                <button class="my-2 btn btn-outline-success my-sm-0" name="" type="submit">Tìm Kiếm</button>
                            </form>
                        </li>
                    </ul>
                </div>
